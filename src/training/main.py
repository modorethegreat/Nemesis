...
def main():
    ...
    if not os.path.exists(tfrecord_path):
        ...
        download_script_path = os.path.join(os.getcwd(), 'data', 'deepmind-research', 'meshgraphnets', 'download_dataset.sh')
        ...
        try:
            subprocess.run(download_command, check=True, cwd=os.path.join(os.getcwd(), 'data', 'deepmind-research', 'meshgraphnets'))
